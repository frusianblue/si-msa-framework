...
- ⏭️ **다음 후보**: (devops) CI 게이트 + 멀티모듈 jacoco 집계 · **그릇 정비**(게이트웨이 런타임 점검·k8s 멀티서비스/CI-CD) · (선택) 아카이빙 후속 tar/tar.gz·RetryUtils · 규제특화 잔여(pki/hsm/recon/egov) · (선택) saga 단계별 타임아웃/보상 재시도·실DB 통합테스트
